...
- 기준 커밋: `3871e21f4d583ff87465a347e048bba90323f213`
- 의미: 참여자별 만족도·공정성 점수 구현을 시작하기 직전의 전체 상태다.
- 안전하게 확인하거나 복구할 때는 현재 작업을 덮어쓰지 말고 별도 브랜치를 만든다.

```bash
git switch -c restore/pre-fairness 3871e21f4d583ff87465a347e048bba90323f213
```

공정성 구현 중 문제가 생기면 위 커밋을 기준으로 변경 내용을 비교한다.
