...
from app.graph.build_candidates_graph import get_candidates_graph
...
async def context_message(
    ...
    return ContextMessageResponse(reply=result["reply"], candidate_dates=result.get("candidate_dates"))
